...
public class FenetreUpdate extends FenetreMain {

	private static final long serialVersionUID = 3546230441920597143L;
	
	JPanel containerInfoPanel = new JPanel();
	JPanel contentPanel = new JPanel();

	FenetreUpdate(Application application, FenetreMain fenetre) {
